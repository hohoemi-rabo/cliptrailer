...
**台本生成ルール:**
- フック: 言い切り形式（疑問形「？」は避ける）、衝撃の事実・具体的数字・ネガティブ要素を含める
- CTA: 外部誘導ではなく「いいね・コメント」を促す（例：「共感したらいいね」「感想コメントで教えて」）

### 画像生成
- Gemini 3 Pro で4枚生成（hook, benefit, conclusion, cta）
- **スタイル選択（4種類）**:
  - マンガ風（男性キャラ）: テック系、30-50代男性
  - マンガ風（女性キャラ）: クリエイティブ系、20-30代女性
  - ピクセルアート風: レトロゲーム風、ちびキャラ
  - イラスト風（人物なし）: フラットでポップ、抽象的
...
### キャプション生成
- SNS投稿用キャプション（100-150文字、絵文字使用）
- エンゲージメント促進を含める（「いいね・コメント」誘導）
- 外部サイトへの誘導は入れない
- ハッシュタグ5個自動生成

## ドキュメント

- `docs/tiktok-strategy.md` - TikTok戦略分析（エンゲージメント向上のための指針）
